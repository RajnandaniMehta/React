...
function App() {
  ...
  return (
    <>
      ...
      style={{backgroundImage:`url('https://media.istockphoto.com/id/539236471/photo/wheel-of-currency.webp?a=1&b=1&s=612x612&w=0&k=20&c=qMgVlDVr8gZr0n-GyQAY27Lc03MIQ35njrtszvCynEQ=')`}}>
